...
import { Plus, User, Briefcase, GraduationCap, Award, Phone, MapPin, Mail, Globe, Code, Languages, Heart, ChevronRight, MoreHorizontal } from 'lucide-react';
...
const Sidebar = () => {
    const [sections, setSections] = useState([
        ...
        {id:3, name: 'Education', icon: GraduationCap, isDefault: true, isActive: false},
        {id:4, name: 'Experience', icon: Briefcase, isDefault: true, isActive: false},
        {id:5, name: 'Skills', icon: Code, isDefault: true, isActive: false},
        {id:6, name: 'Certifications', icon: Award, isDefault: true, isActive: false}
    ])
    ...
    return(
        <div className='w-80 h-screen bg-card border-r border-border flex flex-col'>
            ...
            <div className="p-6 border-b border-border">
                <h2 className="text-xl font-semibold text-foreground mb-2">CV Sections</h2>
                <p className="text-sm text-muted-foreground">Organize your resume sections</p>
            </div>
                ...
                {sections.map((section) => {
                    ...
                    >
                        ...
                        <ChevronRight className={`w-4 h-4 transition-all ${
                            section.isActive ? 'text-primary rotate-90' : 'text-muted-foreground'
                        }`} />
                        </div>
                    </div>
                    );
